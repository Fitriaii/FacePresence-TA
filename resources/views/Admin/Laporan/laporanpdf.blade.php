    ...
    <div class="container">
        ...
        <div class="title-section">
            ...
            @if(isset($filter['mapel']))
                <div class="title">Mata Pelajaran: {{ $filter['mapel'] }}</div>
            @endif
        ...
        <div class="filter-info">
            ...
            <div class="filter-grid">
                ...
                {{-- Guru Pengajar (jika ada) --}}
                @if(isset($filter['guru_mapel']))
                    <div class="filter-item">
                        <span class="filter-label">Guru Pengajar:</span> {{ $filter['guru_mapel'] }}
                    </div>
                @endif
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @if(isset($filter['mapel']))
                            <td class="text-center">{{ $filter['mapel'] }}</td>
                        @endif
        ...
        <div class="footer">
            <div class="summary">
                ...
                @if(isset($filter['mapel']))
                    <div><strong>Mata Pelajaran:</strong> {{ $filter['mapel'] }}</div>
                @endif
                ...
                @php
                    ...
                    // Hitung rata-rata kehadiran untuk mata pelajaran
                    $totalPertemuan = count($presensi) > 0 ? count($presensi) / count($rekap) : 0;
                    $avgKehadiran = count($presensi) > 0 ? ($statusCount['hadir'] / count($presensi)) * 100 : 0;
                @endphp
                ...
                @if(isset($filter['mapel']))
                    <div><strong>Rata-rata Kehadiran:</strong> {{ number_format($avgKehadiran, 1) }}%</div>
                    @if($totalPertemuan > 0)
                        <div><strong>Total Pertemuan:</strong> {{ number_format($totalPertemuan, 0) }} kali</div>
                    @endif
                @endif
            </div>
