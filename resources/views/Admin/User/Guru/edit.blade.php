...
<div class="container p-6 mx-auto">
    ...
    <div class="z-50 p-4 mb-4 bg-white rounded-sm shadow font-heading">
        <div class="flex items-center justify-between">
            <h2 class="text-lg font-bold text-purple-800 font-heading">Edit Data Guru</h2>
            <div class="flex space-x-1 font-sans text-xs text-gray-500">
                ...
                <span>/</span>
                <span class="text-gray-400">Edit Guru</span>
            </div>
        </div>
    </div>
    ...
    <div class="p-6 mb-2 bg-white border border-gray-200 rounded-sm shadow-lg">
        ...
        <!-- Form -->
        <form id="guruForm" class="space-y-4" method="POST" action="{{ route('guru.update', $guru) }}" enctype="multipart/form-data">
            @method('PATCH')
            @csrf
