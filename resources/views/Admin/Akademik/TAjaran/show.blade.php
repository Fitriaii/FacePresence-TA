...
<div class="container p-6 mx-auto">
    ...
    <div class="w-full p-6 mb-8 bg-white border border-gray-200 rounded-lg shadow-sm drop-shadow">
        ...
        <div class="flex items-center mb-2">
            <a href="{{ route('tahunajaran.index') }}" class="inline-flex items-center px-4 py-2 font-sans text-sm font-medium text-white bg-purple-500 rounded-lg hover:bg-purple-600">
