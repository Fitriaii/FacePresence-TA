...
<div class="container p-6 mx-auto">
    ...
    <div class="z-50 p-4 mb-4 bg-white rounded-sm shadow font-heading">
        <div class="flex items-center justify-between">
            <h2 class="text-lg font-bold text-purple-800 font-heading">Detail Data Jadwal</h2>
            <div class="flex space-x-1 font-sans text-xs text-gray-500">
                ...
                <span>/</span>
                <span class="text-gray-400">Detail Jadwal</span>
            </div>
        </div>
    </div>
    ...
    <div class="w-full p-6 mb-8 bg-white border border-gray-200 rounded-lg shadow-sm drop-shadow">
        ...
        <div class="w-full">
            <div class="p-4">
                <div class="mb-8">
                    <h2 class="pb-2 mb-6 text-lg font-semibold text-purple-900 border-b border-gray-200">Informasi Jadwal Pelajaran</h2>
                    ...
                    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="p-3 border rounded-lg bg-gray-50">
                                <p class="text-sm text-gray-900">{{ $jadwal->hari }}</p>
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="p-3 border rounded-lg bg-gray-50">
                                <p class="text-sm text-gray-900">{{ $jadwal->kelas->nama_kelas }}</p>
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="p-3 border rounded-lg bg-gray-50">
                                <p class="text-sm text-gray-900">{{ $jadwal->jam_mulai }}</p>
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="p-3 border rounded-lg bg-gray-50">
                                <p class="text-sm text-gray-900">{{ $jadwal->jam_selesai }}</p>
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="p-3 border rounded-lg bg-gray-50">
                                <p class="text-sm text-gray-900">{{ $jadwal->mapel->nama_mapel }}</p>
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="p-3 border rounded-lg bg-gray-50">
                                <p class="text-sm text-gray-900">{{ $jadwal->mapel->guru->nama_guru }}</p>
                            </div>
                        </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="p-3 border rounded-lg bg-gray-50">
                                <p class="text-sm text-gray-900">{{ $jadwal->updated_at->format('d M Y, H:i') }}</p>
                            </div>
                        </div>
