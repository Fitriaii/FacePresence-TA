...
<div class="container p-6 mx-auto">
    ...
    <div class="z-50 p-4 mb-4 bg-white rounded-sm shadow font-heading">
        <div class="flex items-center justify-between">
            <h2 class="text-lg font-bold text-purple-800 font-heading">Detail Data Mata Pelajaran</h2>
            <div class="flex space-x-1 font-sans text-xs text-gray-500">
                ...
                <span>/</span>
                <span class="text-gray-400">Detail Mata Pelajaran</span>
            </div>
        </div>
    </div>
    ...
    <div class="w-full p-6 mb-8 bg-white border border-gray-200 rounded-sm shadow-sm drop-shadow">
        ...
        <div class="flex items-center mb-2">
            <a href="{{ route('mapel.index') }}" class="inline-flex items-center px-4 py-2 font-sans text-sm font-medium text-white bg-purple-500 rounded-lg hover:bg-purple-600">
            ...
            <div class="p-4">
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                        <!-- Tahun Ajaran -->
                        <div class="space-y-2">
                            <label class="text-sm font-medium text-gray-700">Kode Mata Pelajaran</label>
                            <div class="p-3 border rounded-lg bg-gray-50">
                                <p class="text-sm text-gray-900">{{ $mapel->kode_mapel }}</p>
                            </div>
                        </div>

                        <!-- Tahun Ajaran -->
                        <div class="space-y-2">
                            <label class="text-sm font-medium text-gray-700">Nama Mata Pelajaran</label>
                            <div class="p-3 border rounded-lg bg-gray-50">
                                <p class="text-sm text-gray-900">{{ $mapel->nama_mapel }}</p>
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="p-3 border rounded-lg bg-gray-50">
                                <p class="text-sm text-gray-900">{{ $mapel->guru->nama_guru }}</p>
                            </div>
                        </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="p-3 border rounded-lg bg-gray-50">
                                <p class="text-sm text-gray-900">{{ $mapel->created_at->format('d M Y, H:i') }}</p>
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="p-3 border rounded-lg bg-gray-50">
                                <p class="text-sm text-gray-900">{{ $mapel->updated_at->format('d M Y, H:i') }}</p>
                            </div>
                        </div>
