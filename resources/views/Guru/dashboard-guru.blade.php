...
<div class="container p-6 mx-auto">
    <div class="mb-1 bg-white rounded-sm shadow-sm ">
        <div class="p-4">
            <h1 class="text-2xl font-bold text-purple-800 font-heading">Dashboard Guru</h1>
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="p-6 text-white transition-all duration-300 shadow-md rounded-xl bg-gradient-to-br from-orange-500 to-red-500 hover:shadow-xl hover:scale-105">
                    ...
                    <div class="pt-4 border-t border-white border-opacity-50">
                        <div class="flex items-center justify-center space-x-2">
                            <div class="p-1 bg-blue-500 rounded-full bg-opacity-70">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-3 h-3">
                                    <path fill-rule="evenodd" d="M4.848 2.771A49.144 49.144 0 0 1 12 2.25c2.43 0 4.817.178 7.152.52 1.978.292 3.348 2.024 3.348 3.97v6.02c0 1.946-1.37 3.678-3.348 3.97a48.901 48.901 0 0 1-3.476.383.39.39 0 0 0-.297.17l-2.755 4.133a.75.75 0 0 1-1.248 0l-2.755-4.133a.39.39 0 0 0-.297-.17 48.9 48.9 0 0 1-3.476-.384c-1.978-.29-3.348-2.024-3.348-3.97V6.741c0-1.946 1.37-3.68 3.348-3.97Z" clip-rule="evenodd" />
                                </svg>
                            </div>
                            <div class="text-xs ">
                                <span class="font-semibold text-blue-500">{{ $rataRataKehadiran }}%</span> rata-rata kehadiran
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 text-white transition-all duration-300 shadow-md rounded-xl bg-gradient-to-br from-pink-500 to-violet-500 hover:shadow-xl hover:scale-105">
                    ...
                    <div class="pt-4 border-t border-white border-opacity-50">
                        <div class="flex items-center justify-center space-x-2">
                            <div class="p-1 bg-green-500 rounded-full bg-opacity-70">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-3 h-3">
                                    <path fill-rule="evenodd" d="M11.47 2.47a.75.75 0 0 1 1.06 0l7.5 7.5a.75.75 0 1 1-1.06 1.06l-6.22-6.22V21a.75.75 0 0 1-1.5 0V4.81l-6.22 6.22a.75.75 0 1 1-1.06-1.06l7.5-7.5Z" clip-rule="evenodd" />
                                </svg>
                            </div>
                            <div class="text-xs ">
                                <span class="font-semibold text-green-500">{{ $kelasAktifHariIni }}</span> kelas aktif hari ini
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 text-white transition-all duration-300 shadow-md rounded-xl bg-gradient-to-br from-blue-500 to-teal-500 hover:shadow-xl hover:scale-105">
                    ...
                    <div class="pt-4 border-t border-white border-opacity-50">
                        <div class="flex items-center justify-center space-x-2">
                            <div class="p-1 bg-red-500 rounded-full bg-opacity-70">
                            ...
                            <div class="text-xs">
                                <span class="font-semibold text-red-500">{{ $siswaAlpha }}</span> siswa alpha hari ini
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 text-white transition-all duration-300 shadow-md rounded-xl bg-gradient-to-br from-indigo-500 to-purple-500 hover:shadow-xl hover:scale-105">
                    ...
                    <div class="pt-4 border-t border-white border-opacity-50">
                        <div class="flex items-center justify-center space-x-2">
                            ...
                            <div class="text-xs ">
                                <span class="font-semibold text-red-500">{{ $jadwalSelanjutnya }}</span> jadwal selanjutnya
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="grid grid-cols-1 gap-1 lg:grid-cols-2">
        ...
        <div class="bg-white rounded-sm shadow-sm">
            <div class="p-6">
                <h2 class="mb-4 text-xl font-bold text-purple-800 font-heading">Jadwal Mengajar Hari Ini</h2>
                        ...
                        <div class="p-4 transition-shadow border border-gray-200 rounded-lg bg-gradient-to-r from-blue-50 to-indigo-50 hover:shadow-md">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="text-right">
                                    ...
                                    @else
                                        <a href="{{ route('presensiJadwal.create', $jadwal->id) }}" class="inline-flex items-center px-3 py-1 text-xs font-semibold text-blue-700 transition-colors bg-blue-100 rounded-full hover:bg-blue-200">
                                            Ambil Presensi
                                        </a>
                                    @endif
                                </div>
        ...
        <div class="bg-white rounded-sm shadow-sm">
            <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                    <div>
                        <h2 class="text-xl font-bold text-purple-800 font-heading">Statistik Presensi Kelas</h2>
                ...
                <div class="space-y-4">
                    @forelse ($statistikKelas as $kelas)
                        @php
                            $persen = min(100, round($kelas->persentase_kehadiran, 1));
                        @endphp
                        <div class="p-4 border border-gray-200 rounded-lg">
                            <div class="flex items-center justify-between mb-2">
                                <h3 class="font-semibold text-gray-900">{{ $kelas->nama_kelas }}</h3>
                                <span class="text-sm font-medium text-gray-600">{{ $persen }}%</span>
                            </div>
    ...
    <div class="mt-1 bg-white rounded-sm shadow-sm">
        <div class="p-6">
            <h2 class="mb-4 text-xl font-bold text-purple-800 font-heading">Rekapan Presensi Terbaru</h2>

            <div class="overflow-auto rounded-sm shadow-sm">
                <table class="min-w-full text-sm whitespace-nowrap">
                    <thead>
                        <tr class="text-sm font-semibold text-gray-700 uppercase bg-gray-100 font-heading">
                    ...
                    <tbody>
                        @forelse ($riwayatPresensi as $riwayat)
                            <tr class="text-sm text-gray-700 border-t hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-left">{{ $riwayat->kelas }}</td>
                                <td class="px-4 py-3 text-left">{{ $riwayat->nis }}</td>
                                <td class="px-4 py-3 text-left">{{ $riwayat->nama }}</td>
